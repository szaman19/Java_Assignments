...
public class MemoryViewPanel implements Observer {
	...
	/*
	 * In MemoryViewPanel, the private fields are
machineView (type MachineView),
scroller (type JScrollPane),
dataDecimal and dataHex (both type JTextField[], instantiated to an array of length Memory.DATA_SIZE),
ints lower, upper and previousColor, initially -1.
 
The constructor has three parameters to set the fields machineView, lower and upper and then calls machineView.addObserver(this). 
	 */
