...
public class CodeViewPanel implements Observer {
	...
	/*
	 * The constructor has one parameter to set machineView and then has the line machineView.addObserver(this);    
	 * The method addObserver is inherited into MachineView from Observable.
	 */
	...
	public void update(Observable arg0, Object arg1) {
		if(arg1 != null && arg1.equals("Load Code")) {
			code = machineView.getCode(); /////NEW LAB12
			for(int i = 0; i < Code.CODE_MAX; i++) {
